...
impl Person{
    ...
    // Initizalizing ftns
    fn new() -> Person {                                 
        Self { citizenship: String::from("USA"),       
...
fn main() {
    ...
    // Are used to represent information about something more complicated
    // than a single number charachter
    // -------------------------------------------
    // 			Structures 
    ...
    println!("Person name : {} and Citizenship : {}", person2.name, person2.citizenship);  

    let person3 = Person{      
        age: 50, 
        name: String::from("Kamran"),
        ..person1 // if you want the value to be remain same
    };
    println!("The name of person 3 : {}, his salary : {}", person3.name, person3.salary);

    let mut person4 = Person::new(); 
    println!("The default name of person 4 : {}", person4.name); 
    person4.name = String::from("Asif"); 
    println!("The updated name of person 4 : {}", person4.name);
}
